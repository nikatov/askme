...
class Topic(models.Model):
    subject = models.CharField(u'Тема', default='Нет темы', max_length=255)
...
class Comment(models.Model):
    ...
    text = models.TextField(u'Текст')
    reply_to = models.ForeignKey('question.Comment', null=True, blank=True, on_delete=models.PROTECT)
    creation_date = models.DateTimeField(u'Дата создания', auto_now_add=True)

    def __str__(self):
        # return f"{self.author_nick} -> {self.topic}"
